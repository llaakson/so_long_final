...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   big_map_helper_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: llaakson <llaakson@student.hive.fi>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/11 18:52:48 by llaakson          #+#    #+#             */
/*   Updated: 2024/09/11 20:51:35 by llaakson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	open_window(t_game *game)
{
	if (game->big == 0)
	{
		game->mlx_win = mlx_new_window(game->mlx, game->window_w
				* IMG_SIZE, game->window_h * IMG_SIZE, "so_long_bonus");
	}
	if (game->big == 1)
	{
		game->mlx_win = mlx_new_window(game->mlx, game->window_w_big
				* IMG_SIZE, game->window_h_big * IMG_SIZE, "so_long_bonus");
	}
	if (!game->mlx_win)
	{
